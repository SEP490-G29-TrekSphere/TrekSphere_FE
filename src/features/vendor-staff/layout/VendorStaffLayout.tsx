...
export default function VendorStaffLayout() {
  ...
  // Không có header desktop — mỗi trang tự dựng tiêu đề/thanh công cụ của mình,
  // giống VendorManagerLayout và CoordinatorLayout. Dưới md, `RoleDashboardShell`
  // thêm top bar mở drawer vì sidebar bị ẩn.
  return (
    <RoleDashboardShell
      sidebar={sidebar}
      mobileTitle={<span style={{ color: '#06261D' }}>TrekPartner</span>}
      style={{ backgroundColor: '#FAF8F1' }}
      sidebarStyle={{ backgroundColor: '#EFECE6' }}
      sidebarClassName="md:border-r md:border-[#E0DCD1]"
