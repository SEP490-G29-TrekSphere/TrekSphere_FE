  ...
  return (
    ...
    >
      <div className="max-w-[1200px] w-full px-4 sm:px-6 text-center">
        <ScrollReveal variant="fade-up" scrollOptions={{ threshold: 0.1 }}>
        ...
        <ScrollReveal variant="fade-up" scrollOptions={{ delay: 0, threshold: 0.1 }}>
          <p className="mt-5 text-white/90 text-base md:text-lg leading-relaxed max-w-[720px] mx-auto">
            Trải nghiệm trekking chuyên nghiệp, an toàn và bền vững cùng đội ngũ chuyên gia hàng
            đầu. Khám phá vẻ đẹp hùng vĩ của núi rừng Việt Nam qua những hành trình độc bản.
          </p>
        </ScrollReveal>
