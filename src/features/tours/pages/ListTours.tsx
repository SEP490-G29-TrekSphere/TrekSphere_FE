import { TourCard, TourPagination, TourSearchBar } from '@/features/tours';
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div
            ...
            className="flex flex-col rounded-2xl bg-card border border-border/60 shadow-sm"
          >
    ...
    <div className="flex flex-col gap-5">
      {Array.from({ length: 4 }).map((_, i) => (
        <div
          ...
          key={`featured-tour-skeleton-${i}`}
          className="flex gap-4 rounded-2xl bg-card border border-border/60 p-3 shadow-sm sm:p-4"
        >
