 ...
 *
 * Bố cục (đồng bộ với màn Tour Approval):
...
/** Mảng id tĩnh cho 5 ngôi sao đánh giá — tránh dùng index làm key. */
          ...
          <div className="space-y-5">
            ...
            >
              ...
              <p className="mb-5 text-sm" style={{ color: '#6F7B75' }}>
                Những thao tác dưới đây có thể ảnh hưởng nghiêm trọng đến tài khoản người dùng. Vui
                lòng cân nhắc kỹ trước khi thực hiện.
              </p>
    ...
    >
      ...
      {showStars && (
        <div className="mb-2 flex items-center gap-0.5">
          {STAR_IDS.map((id) => (
            <Star key={id} className="h-4 w-4" fill="#F59E0B" stroke="#F59E0B" />
          ))}
        </div>
      )}
      {subText && (
