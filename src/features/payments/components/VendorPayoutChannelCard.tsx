  ...
  return (
    <AppCard className="overflow-hidden rounded-[28px] border-[#DED9CA] bg-white p-0 shadow-[0_10px_35px_rgba(30,57,50,0.06)]">
      <div className="border-b border-[#EAE6DC] bg-[#FBF8F0] p-5 sm:p-6">
        ...
        <h2 className="mt-0.5 text-lg font-extrabold text-[#1E3932]">Tự động chuyển tiền hoàn</h2>
        <p className="mt-1 text-xs font-medium leading-relaxed text-[#6F7E72]">
          Kết nối Kênh Chi payOS để tự động hoàn tiền cho khách. Đây là cấu hình tùy chọn; nếu chưa
          kết nối, bạn vẫn nhận booking và hoàn tiền bằng chuyển khoản thủ công khi có yêu cầu.
        </p>
      </div>
