...
interface PorterPaginationProps {
  currentPage: number;
  totalPages: number;
...
/** Footer phân trang cho bảng porter — cùng UI với `EquipmentPagination`/`StaffPagination`. */
export function PorterPagination({
  currentPage,
  totalPages,
  onPageChange,
  totalCount,
  pageSize,
}: PorterPaginationProps) {
