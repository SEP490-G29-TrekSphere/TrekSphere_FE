...
function ToastItem({ toast }: { toast: ToastMessage }) {
  ...
  return (
    <div
      className={`pointer-events-auto flex w-full max-w-sm items-center justify-between space-x-4 overflow-hidden rounded-md border p-4 shadow-lg transition-all duration-300 animate-in slide-in-from-right-full fade-in ${toastStyles[toast.type]}`}
      role="alert"
    >
