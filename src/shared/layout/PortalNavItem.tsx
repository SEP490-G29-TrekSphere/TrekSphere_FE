  ...
  if (disabled) {
    return (
      <div className="relative group flex items-center justify-center">
        <span
          className={cn(
            'flex items-center text-sm font-semibold opacity-40 cursor-not-allowed select-none transition-all text-muted-foreground',
            collapsed
        ...
        {/* Floating Tooltip - only visible on Desktop when sidebar is collapsed */}
        {collapsed && (
          <div className="pointer-events-none absolute left-full top-1/2 -translate-y-1/2 ml-3 hidden md:group-hover:flex items-center z-50">
            <div className="relative rounded-lg bg-primary px-3 py-1.5 text-xs font-semibold text-primary-foreground shadow-xl whitespace-nowrap animate-in fade-in zoom-in-95 duration-150">
              {name} (chưa thực hiện)
